    ...
    <div style={{ background: 'white', borderRadius: 18, border: '2px solid #b8ddd0', padding: 14 }}>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        <button onClick={newImages}
          style={{ flex: 1, background: 'white', border: '2px solid #b8ddd0', borderRadius: 12, padding: 11, fontSize: 13, fontWeight: 700, cursor: 'pointer', color: '#7aab96' }}>
          🔄 תמונות חדשות
        </button>
        <button onClick={clear}
          style={{ flex: 1, background: 'white', border: '2px solid #f4a261', borderRadius: 12, padding: 11, fontSize: 13, fontWeight: 700, cursor: 'pointer', color: '#f4a261' }}>
          🗑️ נקה
        </button>
      </div>
    </div>
